            ...
            var claims = new[]
                {
                    ...
                    new Claim(System.IdentityModel.Claims.ClaimTypes.Name, "FirstName"),
                    new Claim(ClaimTypes.Surname, "LastName"),
                    new Claim(ClaimTypes.Role, "dbadmin"),   
                    new Claim(ClaimTypes.Role, "admin"),    
                    new Claim(ClaimTypes.Role, "networkadmin"),   
                    new Claim(ClaimTypes.Email, "administrator@sso.lcl"),
                    new Claim(ClaimTypes.Sid, "sid-S-1-5-77-77-7777777777-777777777"),
                    new Claim(ClaimTypes.WindowsDeviceGroup, @"BUILTIN\Users"),
                    new Claim(ClaimTypes.WindowsDeviceGroup, @"BUILTIN\Other")
                };
